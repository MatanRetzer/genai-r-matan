...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'courses.card.more': 'פרטים נוספים',
    'courses.modal.overview': 'תיאור הקורס',
    'courses.modal.learn': 'מה לומדים?',
    'courses.modal.detailed': 'סילבוס מפורט',
    'courses.modal.close': 'סגירה',
    'courses.modal.register': 'הרשמה לקורס',
  ...
  en: {
    ...
    'courses.card.more': 'More details',
    'courses.modal.overview': 'Course overview',
    'courses.modal.learn': 'What you will learn',
    'courses.modal.detailed': 'Detailed syllabus',
    'courses.modal.close': 'Close',
    'courses.modal.register': 'Register for course',
